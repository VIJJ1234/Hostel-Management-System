...
const StudentProfile = () => {
  ...
  if (!student) return <div className="text-center mt-4 text-gray-600">No student data found.</div>;
    ...
    <div className="container mx-auto p-6 bg-gradient-to-r from-purple-50 to-purple-100 min-h-screen">
      ...
      <div className="bg-white shadow-xl rounded-lg max-w-xl mx-auto p-6">
        {[
          ...
          { label: 'Parent Name', value: student.parentDetails?.name || 'N/A' },
          { label: 'Parent Email', value: student.parentDetails?.email || 'N/A' },
          { label: 'Parent Phone', value: student.parentDetails?.phone || 'N/A' }
        ].map((field, index) => (
